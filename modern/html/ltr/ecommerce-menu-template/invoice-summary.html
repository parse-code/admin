...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>Invoice Summary - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard</title>
  ...
  <body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="#"><i class="la la-clipboard"></i><span class="menu-title" data-i18n="nav.invoice.main">Invoice</span></a>
            <ul class="menu-content">
              <li class="active"><a class="menu-item" href="invoice-summary.html" data-i18n="nav.invoice.invoice_summary">Invoice Summary</a>
              </li>
    ...
    <!-- END MODERN JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="../../../app-assets/js/scripts/pages/invoice-total-recievables.js"></script>
    <script src="../../../app-assets/js/scripts/pages/invoice-sales-and-expenses.js"></script>
    <script src="../../../app-assets/js/scripts/pages/invoice-top-expenses.js"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_toggle">Toggle Sidebar</button>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_open">Open Sidebar</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_close">Close Sidebar</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_pos_toggle">Toggle Sidebar Position</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_pos_right">Right Sidebar Position</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_pos_left">Left Sidebar Position</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_mini_toggle">Toggle Mini Mode</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_mini_on">Enable Mini Mode</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_mini_off">Disable Mini Mode</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_style_toggle">Toggle Sidebar Style</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_style_light">Light Themed Sidebar</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="sidebar_style_dark">Dark Themed Sidebar</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="side_overlay_toggle">Toggle Side Overlay</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="side_overlay_open">Open Side Overlay</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="side_overlay_close">Close Side Overlay</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="side_overlay_mode_hover_toggle">Toggle Hover Mode</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="side_overlay_mode_hover_on">Enable Hover Mode</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="side_overlay_mode_hover_off">Disable Hover Mode</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="side_scroll_toggle">Toggle Side Scrolling</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="side_scroll_native">Enable Native Scrolling</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="side_scroll_custom">Enable Custom Scrolling</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="header_mode_toggle">Toggle Header Mode</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="header_mode_static">Static Header</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="header_mode_fixed">Fixed Header</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="header_glass_toggle">Toggle Header Glass</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="header_glass_on">Enable Header Glass</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="header_glass_off">Disable Header Glass</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="header_style_toggle">Toggle Header Style</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="header_style_light">Light Themed Header</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="header_style_dark">Dark Themed Header</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="footer_mode_toggle">Toggle Footer Mode</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="footer_mode_static">Static Footer</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="footer_mode_fixed">Fixed Footer</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="content_layout_toggle">Toggle Content Layout</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="content_layout_boxed">Boxed Content Layout</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="content_layout_narrow">Narrow Content Layout</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" data-toggle="layout" data-action="content_layout_full_width">Full Width Content Layout</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>

...
<div class="content">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="block block-rounded block-bordered invisible" data-toggle="appear" data-class="animated bounceIn">
                <div class="block-content block-content-full">
                    <div class="py-5 text-center">
        ...
        <div class="col-sm-4">
            <div class="block block-rounded block-bordered invisible" data-toggle="appear" data-class="animated flipInX">
                <div class="block-content block-content-full">
                    <div class="py-5 text-center">
                        <div class="item item-2x item-circle bg-info text-white mx-auto">
        ...
        <div class="col-sm-4">
            <div class="block block-rounded block-bordered invisible" data-toggle="appear" data-class="animated flash">
                <div class="block-content block-content-full">
                    <div class="py-5 text-center">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="block block-rounded block-bordered invisible" data-toggle="appear" data-offset="-200">
                <div class="block-content block-content-full">
                    <div class="py-5 text-center">
        ...
        <div class="col-sm-4">
            <div class="block block-rounded block-bordered invisible" data-toggle="appear" data-offset="-400">
                <div class="block-content block-content-full">
                    <div class="py-5 text-center">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="block block-rounded block-bordered invisible" data-toggle="appear" data-offset="-200" data-timeout="200">
                <div class="block-content block-content-full">
                    <div class="py-5 text-center">
            ...
            <div class="col-sm-4">
                <div class="block block-rounded block-bordered invisible" data-toggle="appear" data-offset="-200" data-timeout="400">
                    <div class="block-content block-content-full">
                        <div class="py-5 text-center">

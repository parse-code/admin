        ...
        <div class="block-content">
            <div class="row items-push">
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn btn-secondary push" data-toggle="modal" data-target="#modal-default-normal">Default</button>
                ...
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn btn-secondary push" data-toggle="modal" data-target="#modal-default-small">Default</button>
                    <!-- END Size: Small -->
                </div>
                <div class="col-md-6">
                    <!-- Size: Large -->
                    ...
                    <button type="button" class="btn btn-secondary push" data-toggle="modal" data-target="#modal-default-large">Default</button>
                    <!-- END Size: Large -->
                </div>
                <div class="col-md-6">
                    <!-- Position: Top -->
                    ...
                    <button type="button" class="btn btn-secondary push" data-toggle="modal" data-target="#modal-default-top">Default</button>
                    <!-- END Position: Top -->
                </div>
                <div class="col-xl-12">
                    ...
                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#modal-default-vcenter">Default</button>
        ...
        <div class="block-content">
            <div class="row items-push">
                ...
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn btn-secondary push" data-toggle="modal" data-target="#modal-default-popin">Default</button>
                    <!-- END Pop In -->
                </div>
                <div class="col-md-6">
                    <!-- Pop Out -->
                    ...
                    <button type="button" class="btn btn-secondary push" data-toggle="modal" data-target="#modal-default-popout">Default</button>
                    <!-- END Pop Out -->
                </div>
                <div class="col-md-6">
                    <!-- Slide Up -->
                    ...
                    <button type="button" class="btn btn-secondary push" data-toggle="modal" data-target="#modal-default-slideup">Default</button>
                    <!-- END Slide Up -->
                </div>
                <div class="col-md-6">
                    <!-- Slide Right -->
                    ...
                    <button type="button" class="btn btn-secondary push" data-toggle="modal" data-target="#modal-default-slideright">Default</button>
                    <!-- END Slide Right -->
                </div>
                <div class="col-md-6">
                    <!-- Slide Left -->
                    ...
                    <button type="button" class="btn btn-secondary push" data-toggle="modal" data-target="#modal-default-slideleft">Default</button>
                    <!-- END Slide Left -->
                </div>
                <div class="col-md-6">
                    <!-- From Right -->
                    ...
                    <button type="button" class="btn btn-secondary push mb-md-0" data-toggle="modal" data-target="#modal-default-fromright">Default</button>
                    <!-- END From Right -->
                </div>
                <div class="col-md-6">
                    <!-- From Left -->
                    ...
                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#modal-default-fromleft">Default</button>
                    <!-- END From Left -->
                </div>
            </div>
        </div>

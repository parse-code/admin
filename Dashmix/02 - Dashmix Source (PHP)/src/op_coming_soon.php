            ...
            <div class="content content-full">
                <div class="row justify-content-center">
                    <div class="col-md-6 py-5 text-center">
                        ...
                        <!-- Countdown.js (.js-countdown class is initialized in js/pages/op_coming_soon.min.js which was auto compiled from _es6/pages/op_coming_soon.js), for more examples you can check out https://github.com/hilios/jQuery.countdown -->

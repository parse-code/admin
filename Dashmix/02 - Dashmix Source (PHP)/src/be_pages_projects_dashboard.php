    ...
    <div class="bg-black-50">
        <div class="content content-full">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a class="btn btn-success my-2" href="be_pages_projects_create.php">
                    <i class="fa fa-fw fa-plus"></i><span class="d-none d-sm-inline ml-1"> New Project</span>
                </a>
            </div>
        </div>
    </div>
            ...
            <div class="block block-rounded block-fx-pop">
                ...
                <div class="block-content block-content-full">
                    <div class="row gutters-tiny">
                        <div class="col-6">
                            <a class="btn btn-block btn-light" href="be_pages_projects_tasks.php">

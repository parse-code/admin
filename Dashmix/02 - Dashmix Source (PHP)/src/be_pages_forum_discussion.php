                ...
                <tbody>
                    <tr class="table-active">
                        ...
                        <td class="font-size-sm text-muted">
                            <a href="be_pages_generic_profile.php"><?php $dm->get_name('female'); ?></a> on <em>July 1, 2018 16:15</em>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr class="table-active">
                        <td class="d-none d-sm-table-cell"></td>
                        <td class="font-size-sm text-muted">
                            <a href="be_pages_generic_profile.php"><?php $dm->get_name('male'); ?></a> on <em>July 10, 2018 10:09</em>
                        </td>
                    </tr>
                    <tr>
                        <td class="d-none d-sm-table-cell text-center" style="width: 140px;">
                    ...
                    <tr class="table-active">
                        <td class="d-none d-sm-table-cell"></td>
                        <td class="font-size-sm text-muted">
                            <a href="be_pages_generic_profile.php"><?php $dm->get_name('male'); ?></a> on <em>July 15, 2018 20:17</em>
                        </td>
                    </tr>
                    <tr>
                        <td class="d-none d-sm-table-cell text-center" style="width: 140px;">
                    ...
                    <tr class="table-active">
                        <td class="d-none d-sm-table-cell"></td>
                        <td class="font-size-sm text-muted">
                            <a href="be_pages_generic_profile.php"><?php $dm->get_name('female'); ?></a> on <em>July 20, 2018 20:29</em>
                        </td>
                    </tr>
                    <tr>
                        <td class="d-none d-sm-table-cell text-center" style="width: 140px;">

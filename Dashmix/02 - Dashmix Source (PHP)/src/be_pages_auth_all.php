...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <!-- Sign In -->
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signin.php">
        ...
        <div class="col-md-6">
            <!-- Sign Up -->
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signup.php">
                <div class="block-content block-content-full">
                    <div class="row py-4">
                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
        ...
        <div class="col-md-6">
            <!-- Lock -->
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_lock.php">
                <div class="block-content block-content-full">
                    <div class="row py-4">
                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
        ...
        <div class="col-md-6">
            <!-- Password Reminder -->
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_reminder.php">
                <div class="block-content block-content-full">
                    <div class="row py-4">
                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
    ...
    <div class="row">
        <div class="col-md-6">
            <!-- Sign In Box -->
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signin_box.php">
                <div class="block-content block-content-full">
                    <div class="row py-4">
                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
        ...
        <div class="col-md-6">
            <!-- Sign Up Box -->
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signup_box.php">
                <div class="block-content block-content-full">
                    <div class="row py-4">
                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
        ...
        <div class="col-md-6">
            <!-- Lock Box -->
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_lock_box.php">
                <div class="block-content block-content-full">
                    <div class="row py-4">
                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
        ...
        <div class="col-md-6">
            ...
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_reminder_box.php">
                <div class="block-content block-content-full">
                    <div class="row py-4">
                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
    ...
    <div class="row">
        <div class="col-md-6">
            <!-- Sign In Box Alt -->
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signin_box_alt.php">
                <div class="block-content block-content-full">
                    <div class="row py-4">
                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
        ...
        <div class="col-md-6">
            <!-- Sign Up Box Alt -->
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signup_box_alt.php">
                <div class="block-content block-content-full">
                    <div class="row py-4">
                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
        ...
        <div class="col-md-6">
            <!-- Lock Box Alt -->
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_lock_box_alt.php">
                <div class="block-content block-content-full">
                    <div class="row py-4">
                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
        ...
        <div class="col-md-6">
            ...
            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_reminder_box_alt.php">
                <div class="block-content block-content-full">
                    <div class="row py-4">
                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">

                ...
                <div class="col-sm-6 col-xl-3 invisible" data-toggle="appear">
                    <a class="block block-bordered block-link-pop text-center mb-0" href="javascript:void(0)">
                        <div class="block-content block-content-full text-center">
                            ...
                            <div class="font-w600 text-uppercase">Dashboard</div>
                        </div>
                    </a>
                </div>
                <div class="col-sm-6 col-xl-3 invisible" data-toggle="appear">
                    <a class="block block-bordered block-link-pop text-center mb-0" href="javascript:void(0)">
                        <div class="block-content block-content-full text-center">
                            ...
                            <div class="font-w600 text-uppercase">Orders</div>
                        </div>
                    </a>
                </div>
                <div class="col-sm-6 col-xl-3 invisible" data-toggle="appear">
                    <a class="block block-bordered block-link-pop text-center mb-0" href="javascript:void(0)">
                        <div class="block-content block-content-full text-center">
                            ...
                            <div class="font-w600 text-uppercase">Customers</div>
                        </div>
                    </a>
                </div>
                <div class="col-sm-6 col-xl-3 invisible" data-toggle="appear">
                    <a class="block block-bordered block-link-pop text-center mb-0" href="javascript:void(0)">
                        <div class="block-content block-content-full text-center">
                            ...
                            <div class="font-w600 text-uppercase">Settings</div>
                        </div>
                    </a>
                </div>
            </div>

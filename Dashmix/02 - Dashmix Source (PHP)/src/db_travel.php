...
<?php $dm->get_css('js/plugins/ion-rangeslider/css/ion.rangeSlider.skinHTML5.css'); ?>
        ...
        <div class="content">
            ...
            <form class="push" action="db_travel.php" method="POST" onsubmit="return false;">
                <div class="form-group mb-2">
                    <input type="text" class="form-control form-control-lg font-size-base border-2x text-center" id="db-travel-location" name="db-travel-location" placeholder="Where are you going?">
                </div>
                <div class="form-group">
                    <div class="input-daterange input-group input-group-lg" data-date-format="mm/dd/yyyy" data-week-start="1" data-autoclose="true" data-today-highlight="true">
                        <input type="text" class="form-control border-right-0 border-2x font-size-base" id="db-travel-from" name="db-travel-from" placeholder="Arriving.." data-week-start="1" data-autoclose="true" data-today-highlight="true">
                        ...
                        <input type="text" class="form-control border-left-0 border-2x font-size-base" id="db-travel-to" name="db-travel-to" placeholder="Leaving.." data-week-start="1" data-autoclose="true" data-today-highlight="true">
                    </div>
                </div>
            </form>
            <!-- END Search Travel -->
            ...
            <div id="side-content" class="d-none d-lg-block push">
                ...
                <div class="block block-rounded block-bordered">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">
                            <i class="fa fa-fw fa-home text-muted mr-1"></i> House Type
                        </h3>
                ...
                <div class="block block-rounded block-bordered block-mode-hidden">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">
                            <i class="fa fa-fw fa-plane text-muted mr-1"></i> Trip
                        </h3>
                        <div class="block-options">
                            <button type="button" class="btn-block-option" data-toggle="block-option" data-action="content_toggle"></button>
                        </div>
                ...
                <div class="block block-rounded block-bordered">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">
                            <i class="fa fa-fw fa-dollar-sign text-muted mr-1"></i> Price Range
                        </h3>
                        <div class="block-options">
                            <button type="button" class="btn-block-option" data-toggle="block-option" data-action="content_toggle"></button>
                        </div>
                ...
                <div class="block block-rounded block-bordered">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">
                            <i class="fa fa-fw fa-box-open text-muted mr-1"></i> Amenities
                        </h3>
                        <div class="block-options">
                            <button type="button" class="btn-block-option" data-toggle="block-option" data-action="content_toggle"></button>
                        </div>
                ...
                <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                    ...
                    <div class="block block-rounded block-fx-pop">
                        ...
                        <div class="block-content block-content-full">
                            <div class="row">
                                <div class="col-6">
                                    <a class="btn btn-sm btn-hero btn-noborder btn-secondary btn-block" data-toggle="layout" data-action="side_overlay_open" href="javascript:void(0)">
                                        View
                                    </a>
                                </div>
                                <div class="col-6">

...
<div class="content content-full">
    ...
    <div class="block block-rounded block-fx-pop block-transparent bg-image" style="background-image: url('<?php echo $dm->assets_folder; ?>/media/photos/photo5.jpg');">
        <div class="block-content block-content-full bg-white-95">
            <div class="d-md-flex justify-content-md-between align-items-md-center">
                <div class="p-3 p-md-4">
                    <h3 class="h4 font-w700 mb-1">Greece Vacation</h3>
                    <p class="mb-0">
                        7 nights - in 20 days
                    </p>
                </div>
                <div class="p-3 p-md-4">
                    <a class="btn btn-sm btn-primary px-3 mr-1 my-1" href="javascript:void(0)">
                        Change
                    </a>
                    <a class="btn btn-sm btn-danger px-3 my-1" href="javascript:void(0)">
    ...
    <div class="block block-rounded block-fx-pop block-transparent bg-image" style="background-image: url('<?php echo $dm->assets_folder; ?>/media/photos/photo12.jpg');">
        <div class="block-content block-content-full bg-black-25 bg-white-95">
            <div class="d-md-flex justify-content-md-between align-items-md-center">
                <div class="p-3 p-md-4">
                    <h3 class="h4 font-w700 mb-1">City Food Tour</h3>
                    <p class="mb-0">
                        3 hours - in 4 months
                    </p>
                </div>
    ...
    <div class="block block-rounded block-fx-pop block-transparent bg-image" style="background-image: url('<?php echo $dm->assets_folder; ?>/media/photos/photo19.jpg');">
        <div class="block-content block-content-full bg-white-95">
            <div class="d-md-flex justify-content-md-between align-items-md-center">
                <div class="p-3 p-md-4">
                    <h3 class="h4 font-w700 mb-1">Mountain Escape</h3>
                    <p class="mb-0">
                        3 nights - in 1 year
                    </p>
                </div>

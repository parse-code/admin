    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-success push" data-toggle="layout" data-action="header_loader_on">Start Header Loader</button>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-danger push" data-toggle="layout" data-action="header_loader_off">Stop Header Loader</button>
                    <p class="font-w600 mb-0">
                        Button Based
                    </p>
                    <p>

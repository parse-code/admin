...
<div class="content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-vcenter mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('content_toggle', '#my-block');">Toggle Content</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('content_hide', '#my-block');">Hide Content</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('content_show', '#my-block');">Show Content</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('state_toggle', '#my-block');">Toggle State</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('state_loading', '#my-block');">State Loading</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('state_normal', '#my-block');">State Normal</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('fullscreen_toggle', '#my-block');">Toggle Fullscreen</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('fullscreen_on', '#my-block');">Fullscreen On</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('fullscreen_off', '#my-block');">Fullscreen Off</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('pinned_toggle', '#my-block');">Toggle Pinned</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('pinned_on', '#my-block');">Pinned On</button>
                                    </td>
                                    <td>
                                        <code>pinned_on</code>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('pinned_off', '#my-block');">Pinned Off</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('close', '#my-block');">Close</button>
                                    </td>
                                    <td>
                                        <code>close</code>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-light btn-block" onclick="Dashmix.block('open', '#my-block');">Open</button>
                                    </td>
                                    <td>
                                        <code>open</code>
                                    </td>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="block block-rounded block-bordered block-mode-loading-location">
                <div class="block-header block-header-default">
        ...
        <div class="col-md-6">
            <div class="block block-rounded block-bordered block-mode-loading-energy">
                <div class="block-header block-header-default">
        ...
        <div class="col-md-6">
            <div class="block block-rounded block-bordered block-mode-loading-sun">
                <div class="block-header block-header-default">
        ...
        <div class="col-md-6">
            <div class="block block-rounded block-bordered block-mode-loading-repeat">
                <div class="block-header block-header-default">

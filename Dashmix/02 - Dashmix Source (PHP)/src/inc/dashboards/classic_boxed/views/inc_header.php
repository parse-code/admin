    ...
    <div class="content-header">
        ...
        <div>
            ...
            <a class="link-fx font-size-lg text-dual" href="index.php">
                <span class="font-w700 text-dual">Dash</span><span class="font-w300">mix</span>
            </a>
            <!-- END Logo -->
        </div>
        <!-- END Left Section -->
        ...
        <div class="d-flex align-items-center">
            ...
            <form class="form-inline d-none d-md-inline-block mr-2" action="be_pages_generic_search.php" method="POST">

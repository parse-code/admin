        ...
        <div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php $dm->get_avatar(16, '', 32, true); ?>
                    <span class="d-none d-lg-inline ml-1">mattd@example.com</span>
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg p-0" aria-labelledby="page-header-user-dropdown">
                    <div class="bg-body-light rounded-top font-w600 text-white text-center p-3">
                        <?php $dm->get_avatar(16); ?>
                        <div class="pt-2">
                            <a class="text-dark font-w600" href="be_pages_generic_profile.php">Matt Doe</a>
                        </div>
                    </div>
                    <div class="p-2">

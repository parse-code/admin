...
<header id="page-header">
    ...
    <div class="content-header">
        ...
        <div class="d-flex align-items-center">
            <!-- Logo -->
            <a class="link-fx font-size-lg font-w600 text-white" href="index.php">
                <span class="text-white-75">x</span><span class="text-white">Analytics</span>
            </a>
            <!-- END Logo -->

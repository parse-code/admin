    ...
    <div class="row">
        <div class="col-sm-6 col-lg-3 invisible" data-toggle="appear">
            <div class="block block-rounded block-fx-pop text-center">
                <div class="block-content block-content-full aspect-ratio-16-9 d-flex justify-content-center align-items-center">
                    <div>
                        <a class="link-fx text-success font-size-h1 font-w700" href="javascript:void(0)">3</a>
                        <div class="font-size-sm font-w700 text-uppercase text-muted mt-1">Domains</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3 invisible" data-toggle="appear" data-timeout="150">
            <div class="block block-rounded block-fx-pop text-center">
                <div class="block-content block-content-full aspect-ratio-16-9 d-flex justify-content-center align-items-center">
                    <div>
                        <a class="link-fx text-success font-size-h1 font-w700" href="javascript:void(0)">1</a>
                        <div class="font-size-sm font-w700 text-uppercase text-muted mt-1">VPS Server</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3 invisible" data-toggle="appear" data-timeout="300">
            <div class="block block-rounded block-fx-pop text-center">
                <div class="block-content block-content-full aspect-ratio-16-9 d-flex justify-content-center align-items-center">
                    <div>
                        <a class="link-fx text-success font-size-h1 font-w700" href="javascript:void(0)">1</a>
                        <div class="font-size-sm font-w700 text-uppercase text-muted mt-1">Active Plan</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3 invisible" data-toggle="appear" data-timeout="450">
            <div class="block block-rounded block-fx-pop text-center">
                <div class="block-content block-content-full aspect-ratio-16-9 d-flex justify-content-center align-items-center">
                    <div>
                        <a class="link-fx text-success text-warning font-size-h1 font-w700" href="javascript:void(0)">$70</a>
                        <div class="font-size-sm font-w700 text-uppercase text-muted mt-1">Pending..</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="block-content block-content-full border-left border-3x border-dark">
            <div class="d-md-flex justify-content-md-between align-items-md-center">
                ...
                <div class="p-1 p-md-3 text-md-right">
                    <a class="btn btn-sm btn-outline-warning btn-rounded px-3 mr-1 my-1" href="javascript:void(0)">
                        <i class="fa fa-redo mr-1"></i> Restart
                    </a>
                    <a class="btn btn-sm btn-outline-secondary btn-rounded px-3 mr-1 my-1" href="javascript:void(0)">
                        <i class="fa fa-wrench mr-1"></i> Manage
                    </a>
                    <a class="btn btn-sm btn-outline-danger btn-rounded px-3 my-1" href="javascript:void(0)">

...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        <ul class="nav nav-tabs nav-tabs-block align-items-center border-bottom">
            <li class="nav-item">
        ...
        <div class="block-content block-content-full">
            <!-- Bitcoin Chart.js Container (.js-chartjs-bitcoin class is initialized in js/pages/db_crypto.min.js which was auto compiled from _es6/pages/db_crypto.js), for more examples you can check out http://www.chartjs.org/docs/ -->
